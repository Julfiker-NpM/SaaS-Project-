    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-br from-slate-900 via-indigo-950 to-slate-900 px-4">
      <div className="w-full max-w-md rounded-2xl border border-white/10 bg-white/5 p-8 shadow-2xl backdrop-blur">
        ...
        <p className="mt-2 text-center text-sm text-slate-300">
          Sign in with Google to manage products, orders, and customers.
        </p>
        ...
        {!firebaseReady && (
          <div className="mt-6 rounded-lg border border-amber-500/40 bg-amber-500/10 p-4 text-sm text-amber-100">
            ...
            <code className="rounded bg-black/30 px-1">.env</code> and add your
            project keys from the Firebase console.
          </div>
        )}
        ...
        <button
          ...
          className="mt-6 flex w-full items-center justify-center gap-2 rounded-xl bg-white px-4 py-3 text-sm font-semibold text-slate-900 shadow-lg transition hover:bg-slate-100 disabled:cursor-not-allowed disabled:opacity-50"
        >
